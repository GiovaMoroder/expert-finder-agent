...
gcp-deploy:
	...
	gcloud run deploy "$$SERVICE" \
		...
		--set-secrets "INFISICAL_PROJECT_ID=INFISICAL_PROJECT_ID:latest,INFISICAL_USER=INFISICAL_USER:latest,INFISICAL_KEY=INFISICAL_KEY:latest,OPENAI_KEY=OPENAI_KEY:latest,APP_TEST_PASSWORD=APP_TEST_PASSWORD:latest,OAUTH2_SECRET_KEY=OAUTH2_SECRET_KEY:latest,DATABASE_URL=DATABASE_URL:latest"
