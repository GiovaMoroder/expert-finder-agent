...
from expert_finder.expert_finder.db.adapters.csv.education_repo import CsvEducationRepository
...
class EducationSearchTool:
    ...
    def __init__(self, education_repo: EducationRepository | None = None) -> None:
        self.education_repo = education_repo or CsvEducationRepository()
